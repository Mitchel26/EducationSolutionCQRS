...
namespace Education.Application.Cursos
{
    ...
    {
        private GetCursoQuery.GetCursoQueryHandler handleAllCursos;
        ...
        public void Setup()
        {
            ...
            cursoRecords.Add(fixture.Build<Curso>().With(tr => tr.CursoId, Guid.Empty).Create()); // Creo un objeto tipo curso sin Id (para probar GetByIdQuery)
            ...
            handleAllCursos = new GetCursoQuery.GetCursoQueryHandler(educationDbContextFake, mapper);
        ...
        public async Task GetCursoQueryHandler_ConsultaCursos_ReturnTrue()
        {
            ...
            var listCursos = await handleAllCursos.Handle(request, new System.Threading.CancellationToken());

            Assert.IsNotNull(listCursos);
        }
    }
}
